...
class Customized_Career_Guidance : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_customized_career_guidance)
       b1= findViewById(R.id.b1)
        val dl : DrawerLayout = findViewById(R.id.drawer_layout)
        val nav: NavigationView = findViewById(R.id.navigation_view)
        val totest: Button = findViewById(R.id.totest)

        val nbtn: ImageView = findViewById(R.id.cgnavbtn)
        introimage=findViewById(R.id.imgcareer)

        val db = FirebaseFirestore.getInstance()

        val dr= db.collection("cards").document("career")
        ...
        totest.setOnClickListener {
            val intent = Intent(this, Big_five_quiz::class.java)
            startActivity(intent)
