...
class onlineprofile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_onlineprofile)
        b= findViewById(R.id.opbbtn)
        messageres = findViewById(R.id.message_opb)
        messageres.setSelection(0)

        introimage=findViewById(R.id.imglinkedin)

        val dl : DrawerLayout = findViewById(R.id.drawer_layout)
        val nav: NavigationView = findViewById(R.id.navigation_view)
        val sub: Button = findViewById(R.id.submit_message3)
        val nbtn: ImageView = findViewById(R.id.opbnavbtn)

        val db = FirebaseFirestore.getInstance()

        val dr= db.collection("cards").document("linkedin")
        ...
        sub.setOnClickListener {
            ...
            fstore.collection("opbque").document()
                .set(a)
            ...
            val b = hashMapOf(
                ...
                "created" to Timestamp.now(),
                "mssg" to messageres.text.toString(),
                "source" to "LinkedIn Upgradation Enquiry",
                "id" to id
            )
        ...
        b.setOnClickListener {
            ...
            intent.putExtra("cname","LinkedIn Profile Upgradation - Paid")
            intent.putExtra("cardtitle","LinkedIn Profile Upgradation- Paid!!")
            startActivity(intent)
        }
