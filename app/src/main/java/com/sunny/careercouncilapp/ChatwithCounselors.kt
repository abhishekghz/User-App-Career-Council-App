...
class ChatwithCounselors : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chatwith_counselors)
        u = findViewById(R.id.freetrial)
        b = findViewById(R.id.booking)

        val dl : DrawerLayout = findViewById(R.id.drawer_layout)
        val nav: NavigationView = findViewById(R.id.navigation_view)

        val nbtn: ImageView = findViewById(R.id.navchatbtn)
        introimage=findViewById(R.id.imgchat)

        val db = FirebaseFirestore.getInstance()
        val dr= db.collection("cards").document("chat")
        ...
        b.setOnClickListener {
            ...
            intent.putExtra("cname","Online Session Booking - Paid")
            intent.putExtra("cardtitle","Online Session Booking for thorough Counselling - Paid!!")
            startActivity(intent)
        }
    }
}